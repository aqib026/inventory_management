...
<div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Permission <small>Add New Permission</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="x_panel">
                  ...
                  {!! Form::model($model, ['route' => ['permissions.store'],'method'=>'post']) !!}
                  ...
                  {!! Form::text('description', '', ['class' => 'form-control','required' => 'required'])  !!}
                    ...
                    <div class="col-offset-6 col-sm-6 center top10" style="margin-top: 10px;">
                      {!!  Form::submit('Create a Permission',['class' => 'btn btn-success'])  !!}
                    </div>
