          ...
          @if(isset($type))
                @if($type=="visit")
                        <tr>
                          ...
                          <th style="color: #1abb9c;">Orders Recieved</th>
                      ...
                      @foreach ($messages as $message)
                        <tr>
                          ...
                          @foreach($orders as $order)
                            @if($order->customer_id == $message->customer_id)
                              <?php $flag=1;?>
                          ...
                          @foreach($orders as $order)
                            @if($order->customer_id == $message->customer_id)
                              ...
                              <td style="color: red">{{number_format($order->amount/$message->trips,2)}}</td>
                              <td style="color: red;">{{number_format($order->no_of_orders/$message->trips,2)}}</td>
                              <?php break;?>
                            @endif
                          @endforeach
                          @if($flag==0)
                ...
                @elseif($type=="watsapp" || $type=="email")
                        <tr>
                          <th>Customer ID</th>
                          <th>customer Name</th>
                          <th>Time</th>
