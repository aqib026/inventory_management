              ...
              <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2>FWS Order # <strong>{{$order->id}}</strong> 
                    &nbsp;&nbsp;&nbsp;
                    <a href="javascript:void(0)" class="btn btn-warning">{{$order->status}}</a>
                  ...
                  <div class="x_content">
                    <table class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tr>
                        <td>VAT Customer</td>
                        <td>@if($order->vat == 1) Yes @else No @endif</td>
              ...
              <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  @if($order->order_status != 'canceled')
                    ...
                    <a href='{{ url("/edit_invoice_qty/$order->order_no") }}'>Edit Qty</a> &nbsp; &nbsp;
                    ...
                    <table class="table table-striped table-bordered dt-responsive nowrap">
                     ...
                     @foreach($products as $p)
                          ...
                          <tr>
                            <td>{{$p->id}}</td>
                            <td>{{$p->sku}}</td>
                            <td>{{$p->product_options[1]->display_value}}</td> <!--size-->
                            <td>{{$p->product_options[0]->display_value}}</td> <!--color-->
                            @if( Auth::user()->can('unit_price') )
                            <td>{{$p->total_inc_tax}}</td>
                            @endif    
                            <td></td>
                            <td>{{$p->quantity}}</td>
                            <td>
