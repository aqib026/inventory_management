  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br>
          {!! Form::open(['route' => 'ebay_templates.store', 'class'=>'form-horizontal form-label-left']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-md-9 col-sm-6 col-xs-12">
                ...
                {!! Form::textarea('item_description', null ,['id'=>'descr', 'class'=>'form-control col-md-7 col-xs-12']) !!}
              </div>
            </div>
