...
class Bvoucher extends Model
{
    //

   protected $table = 'b2s_voucher';
   public $primaryKey = 'voucher_id';
   public $timestamps = false;     	

    public function detail(){
    	return $this->hasMany('App\BvoucherDetail','voucher_id','voucher_id');
    }
    ...
    public static  function generate_voucher($receipt_id){
      ...
      $v = \App\Bvoucher::where('receipt_id',$receipt_id)->first(); 
      if($v != null){        
